...
import { Data as brandingLogoData } from "@/data/brandingLogo";

const allArtworks = [...artworksData, ...brandingLogoData];
              ...
              <CardContent className="p-0 h-full">
                ...
                >
                  <div className="flex flex-col items-start space-y-4 w-full">
                    ...
                    >
                      {artwork.category === "designSystem" ||
                      artwork.category === "brandingLogo" ? (
                        <Link to={`/design-system/${artwork.id}`}>
